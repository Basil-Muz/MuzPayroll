...
<div className="amend-section">
  ...
  />
    ...
    <div className="amend-field">
    <label className="form-label required">Authorization date</label>
<Controller
  ...
  requestAnimationFrame(() => {
    generalInfoRef.current?.focusCompany();
  });
}}
...
{ (latestAmendmentId.authorization === "VERIFIED" && !addingNewAmend) && // Adding the new amend only if the latest amend is verified
    <div 
...
>
        ...
        <div className="pill-right">
          { item.id==latestAmendmentId.id && (
            <span className="pill-badge verified">latest</span>
            )}
          {(item.authorization !== "ENTRY" && item.id !== latestAmendmentId.id) && (
            <span className="pill-badge verified">✔ Verified</span>
          )}
          {(item.authorization == "ENTRY"&& item.id !== latestAmendmentId.id) && (
            <span className="pill-badge verified">Entry</span>
          )}
