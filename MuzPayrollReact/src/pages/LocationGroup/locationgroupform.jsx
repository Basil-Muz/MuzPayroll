                                ...
                                <div className="notifications-dropdown">
                                    {notifications.length > 0 ? (
                                        notifications.map((notification) => (
                                            <p className="error-msg" key={notification.id} style={{ color: 'black' }}>{notification.msg} 
                                            <RxCross2 size={20} color="red" onClick={() => removeNotification(notification.id)} /></p>
                                        ))
                                    ) : (
                ...
                <div className="main-model-content">
                    <div className="full-content">
                        ...
                        <div className="form-row">
                            <label className="required" name="code">Group Code</label>
