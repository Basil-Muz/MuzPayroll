...
function LocationGroupForm({ toggleForm, data }) {
...
//   };
  ...
  return (
    <div className="modal-locationgroup-form" onClick={toggleForm}>
      {/* {" "}
        ...
        <div className="main-model-content">
          <div className="full-content">
            ...
            <div className="form-row">
              <label className="required" name="code">
                Group Code
              </label>
          ...
          <div className="full-content">
            <div className="form-row">
              ...
              <div className="input authorization">
                ...
                >
                  {isVarified && (
                    <option value="VERIFIED">VERIFIED:{data.date}</option>
                  )}
                  {data && !isVarified && (
                    <option value="ENTRY">
                      ENTRY:{data ? data.date : form.date}
                    </option>
                  )}
                  {data && !isVarified && (
                  ...
                  {!data && (
                    <>
                      {" "}
                      <option value="ENTRY">ENTRY:{data && data.date}</option>
                      <option value="VERIFIED">VERIFIED:</option>
                    </>
                  )}
                </select>
