...
function LoggedPage() {
  ...
  // Load saved values + dropdown lists from login API response
  useEffect(() => {
    ...
    // Set dropdown lists (coming from response)
  ...
  // After clicking OK → lock input fields
  const handleOk = () => {
        ...
        <div className="logged-container">
          ...
          <div className="logged-details">
            ...
            <div style={{ textAlign: "center", marginTop: "2px" }}>
              <button className="logged-btn" onClick={handleOk}>
                OK
              </button>
              ...
              <button
                ...
                disabled={fieldsLocked}
                style={{ opacity: fieldsLocked ? 0.5 : 1 }}
                onClick={() => navigate("/")}
              >
                Change Credentials
              </button>
