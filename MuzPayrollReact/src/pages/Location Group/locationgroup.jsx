...
function LocationGroup() {
    ...
    const [advanceTypes, setAdvanceTypes] = useState([
        {
            GroupCode: "LG001",
            GroupName: "Ernakulam-staff",
            ShortName: "Ern-sta",
            Description: "Ernakulam staff group",
            ActiveDate: "01-01-2024"

        },
        {
            GroupCode: "LG002",
            GroupName: "Trivandrum-Staff",
            ShortName: "Triv-sta",
            Description: "Trivandrum staff group",
            ActiveDate: "12-03-2024"
        },
        {
            GroupCode: "LG003",
            GroupName: "Thrissur-Staff",
            ShortName: "Thr-sta",
            Description: "Thrissur staff group",
