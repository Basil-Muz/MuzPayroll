...
//     // ================= FINAL SAVE WRAPPER =================
//     @Transactional
//     public Response<BranchDTO> saveWrapper(BranchDTO dto) {
...
//     @Override
//     public Response<Boolean> entityValidate(List<BranchDTO> dtos) {
...
//         Response<Boolean> logEntityValidate = branchLogService.entityValidate(logDtos);
...
//     // =================== 2️⃣ ENTITY POPULATE ===================
//     @Override
//     public Response<Boolean> entityPopulate(List<BranchDTO> dtos) {
//         List<String> errors = new ArrayList<>();
...
//         List<BranchLogDTO> logDtos = convertToLogDTO(dtos);
//         Response<Boolean> logEntityPopulate = branchLogService.entityPopulate(logDtos);
...
//     @Override
//     public Response<Boolean> businessValidate(List<BranchDTO> dtos) {
...
//         List<BranchLogDTO> logDtos = convertToLogDTO(dtos);
//         Response<Boolean> logbusinessValidate = branchLogService.businessValidate(logDtos);
...
//     // =================== 4️⃣ GENERATE PK ===================
//     @Override
//     public Response<Object> generatePK(List<BranchDTO> dtos) {
//         List<String> errors = new ArrayList<>();
...
//             List<BranchLogDTO> logDtos = convertToLogDTO(dtos);
//             Response<Object> logGeneratePK = branchLogService.generatePK(logDtos);
...
//     @Override
//     public Response<String> generateSerialNo(List<BranchDTO> dtos) {
...
//             List<BranchLogDTO> logDtos = convertToLogDTO(dtos);
//             Response<String> loggenerateSerialNo = branchLogService.generateSerialNo(logDtos);
...
//     protected BranchMst saveEntity(BranchMst entity, List<BranchDTO> dtos) {
//         BranchDTO dto = dtos.get(0);

//         try {
//             // ===== SAVE MAIN FIRST =====
//             BranchMst savedEntity = branchRepository.save(entity);
...
//             List<BranchLogDTO> logDtos = convertToLogDTO(dtos);
//             BranchLog savedLog = branchLogService.saveEntity(logEntity, logDtos);
